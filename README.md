  ...
  <table>
    <tr>
      ...
      <td>
        ...
        <h3>
          🛠 Software Engineer | Internal Tools & AI <br>
        </h3>
        <p>
        I build fullstack internal tools that speed up engineering teams, and apply LLMs & vector search (RAG, embeddings) to product tasks. Background: QA automation.
        </p>
        <p>
